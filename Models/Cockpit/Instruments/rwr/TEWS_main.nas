...
TEWScanvas.addPlacement({"node": "RHWR.screen"});
...
print("TEWS : Load SVG ",canvas.parsesvg(TEWSsvg, "Aircraft/Tornado/Models/Cockpit/Instruments/rhwr/TEWS.svg"));
TEWSsvg.setTranslation (190, 120);
#print("TEWS INIT");
...
var updateTEWS = func ()
{
    ...
    var target_idx = 0;
    var radar_range = 50;#getprop("instrumentation/radar/radar2-range");
...
var timer = maketimer(0.1, updateTEWS);
timer.start();
